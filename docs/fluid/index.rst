...
Below is a minimal sample **conf.py** file to use the fluid theme.
...
.. csv-table::
   ...
   "body_link_color", "#0d8aa1", "link color in the article body"
   ...
   "menu_item_color", "#363638", "header link text color"
